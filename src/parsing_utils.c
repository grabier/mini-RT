...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/20 12:57:43 by gmontoro          #+#    #+#             */
/*   Updated: 2025/09/17 19:43:07 by aehrl            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_check_arg_count(char *str, int arg_count)
{
	...
	i = 1;
	c = str[0];
	if ((c == 's' && str[1] != 'p') || (c == 'p' && str[1] != 'l') || (c == 'c'
			&& str[1] != 'y'))
		return (0);
	if (c == 's' || c == 'p' || c == 'c')
		i++;
	...
	if (c == 'A' && arg_count != 2)
		return (0);
	if ((c == 'C' || c == 'L' || c == 's' || c == 'p') && arg_count != 3)
		return (0);
	if (c == 'c' && arg_count != 5)
		return (0);
	return (1);
...
int	ft_check_argument(char *str)
{
	...
	while (str[i] != '\0')
	{
		if (str[i] == '|')
			...
			&& str[i] != '-' && str[i] != 'A' && str[i] != 'C' && str[i] != 'L'
			&& str[i] != 's' && str[i] != 'p' && str[i] != 'l' && str[i] != 'c'
			&& str[i] != 'y')
			return (0);
